...
expect(overlay.includes('function schedule('),'marketplace ratings need a persistent repaint scheduler')
expect(overlay.includes('MutationObserver'),'marketplace ratings must react to dynamic DOM rerenders')
