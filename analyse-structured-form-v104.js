...
function formMarkup(){return `
 ...
 <div class="field-section"><h3>Price</h3><div class="price-row"><label>Current price<input name="price" type="number" min="0" step="0.01"></label><label>Currency<select name="currency"><option value="">Not stated</option><option value="AUD">AUD</option><option value="USD">USD</option><option value="GBP">GBP</option></select></label><label>Original price <small>before discount</small><input name="original_price" type="number" min="0" step="0.01"></label></div><label class="inline-check"><input name="discounted" type="checkbox"><span>This item is on sale / discounted</span></label><label>Discount / sale note <small>optional</small><input name="discount_note" placeholder="e.g. reduced from $180, 30% off, clearance"></label></div>
