...
update('extension/scout-smart-overview-v066.js',s=>{
  if(!s.includes("lastHtml=''"))s=s.replace("let regionFilter='ALL',categoryFilter='ALL',timer=null","let regionFilter='ALL',categoryFilter='ALL',timer=null,lastHtml=''")
  if(!s.includes('if(html!==lastHtml)')){
...
update('extension/manifest.json',s=>{const m=JSON.parse(s);if(m.version<'0.89.2')m.version='0.89.2';return JSON.stringify(m,null,2)+'\n'})
